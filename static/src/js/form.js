...
openerp.web_m2o_enhanced = function (instance) {
    ...
    instance.web.form.FieldMany2One = instance.web.form.FieldMany2One.extend({
      show_error_displayer: function() {
          if (this.options.m2o_dialog === undefined || this.options.m2o_dialog) {
      ...
      get_search_result: function(search_val) {
        ...
        if (self.options.limit !== undefined && self.options.limit === 'number') {
        ...
        return this.orderer.add(dataset.name_search(
            ...
            if (self.options.create === undefined || self.options.create) {
            ...
            // create...
            if (self.options.create_edit === undefined || self.options.create_edit) {
                values.push({
